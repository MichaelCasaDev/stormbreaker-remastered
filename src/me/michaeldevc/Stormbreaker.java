...
public class Stormbreaker {
    ...
    public void launch() {
        ...
        System.out.format("\n%sCommand example: java -jar Stormbreaker_Remastered.jar host=127.0.0.1 flooder=spigot1%s", ConsoleCoders.ANSI_CYAN, ConsoleCoders.ANSI_RESET);
        System.out.format("\n%sOptions available [ host - port - proxiesType - proxiesFile - srvResolve - alwaysResolve - threads - connections - attackTime - srvResolve2 - keepAlive - flooder - removeFailure - loopAmount ]%s", ConsoleCoders.ANSI_GREEN, ConsoleCoders.ANSI_RESET);
        System.out.format("\n%sFlooders available [ localhost - bosshandler - cpulagger - test1 - test2 - flood1 - flood2 - spigot1 - spigot2 - bypass1 - bypass2 - bypass3 - extreme1 - extreme2 - extreme3 - extreme4 - extreme5 - cpuburner1 - cpuburber2 - cpuburner3 - cpuburner4 - cpuburner5 - cpuburner6 - Destroyer - ZeusSlapper - BypassHub1 - exceptionBypass - AuthSmasher ]%s\n\n", ConsoleCoders.ANSI_RED, ConsoleCoders.ANSI_RESET);
        ...
        if (!this.options.isOption("host")) {
            ...
            System.out.format("%sFlooder: %s%s\n", ConsoleCoders.ANSI_RED, (String)this.options.getOption("flooder", "1"), ConsoleCoders.ANSI_RESET);
